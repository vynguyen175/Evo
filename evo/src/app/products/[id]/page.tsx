            ...
            <div className="relative aspect-[3/4] overflow-hidden bg-neutral-100">
              ...
              {product && (
                <button
                  ...
                  className="absolute top-4 right-4 z-10 p-3 bg-white/90 hover:bg-white rounded-full transition-all duration-300 cursor-pointer group/heart shadow-sm"
                ...
                >
                  <svg
                    ...
                    className={`w-6 h-6 transition-colors ${
                      isInWishlist(product.id || product._id || '') ? 'text-red-500' : 'text-neutral-900 group-hover/heart:text-red-500'
                    }`}
                  >
                    <path
                      strokeLinecap="round"
