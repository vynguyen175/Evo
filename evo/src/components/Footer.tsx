        ...
        <div className="py-16 md:py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-1">
              <Link
                href="/"
                className="font-serif text-3xl tracking-wide text-neutral-900 hover:opacity-70 transition-opacity"
              >
                ÉVO
              </Link>
            ...
            {/* Shop Links */}
            <div>
              <h3 className="text-xs font-medium tracking-wider uppercase text-neutral-900 mb-4">
                Shop
              </h3>
            ...
            <div className="max-w-md">
              ...
              <form className="flex gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 text-sm bg-white border border-neutral-300 focus:border-neutral-900 focus:outline-none transition-colors"
                />
                <button
                  type="submit"
